...
#define	DCDIV	4
	case IDALIASHEADER:
		loadmodel->extradata = Hunk_Begin (/*0x200000*/512*1024);
		Mod_LoadAliasModel (mod, buf);
		break;
		
	case IDSPRITEHEADER:
		loadmodel->extradata = Hunk_Begin (0x10000/DCDIV);
		Mod_LoadSpriteModel (mod, buf);
		break;
	
	case IDBSPHEADER:
		loadmodel->extradata = Hunk_Begin (/*0x1000000*/5*1024*1024);
